...
import CustomSegmentedControl from "../../components/custom/CustomSegmentedControl";
import CustomListItemOption from "../../components/custom/CustomListItemOption";
import CustomButtonDisabled from "../../components/custom/CustomButtonDisabled";
...
import RecurrenceModal from "../../components/custom/CustomModal";
...
interface EditTransactionScreenProps {
  navigation: AppStackScreenProps<"EditTransaction">["navigation"];
  route: {
    params: {
...
export const EditTransactionScreen: FC<EditTransactionScreenProps> = observer(
  function EditTransactionScreen({ navigation, route }) {
    ...
    const loadTransactionData = async () => {
      try {
        ...
        if (transaction) {
          updateField("Transaction_id", route.params.transactionId);
          updateField(
            "transaction_type",
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values, { resetForm }) => {
        try {
          ...
          const originalDate = moment(route.params.transaction.date);
          let formattedDate;
