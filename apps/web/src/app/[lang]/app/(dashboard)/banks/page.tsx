...
function BankItem({ bank, lang }: { bank: Bank; lang: string }) {
  return (
    <Link href={`/${lang}/app/banks/${bank.id}`} className="dash-list-item">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link href={`/${lang}/app/banks/new`} className="dash-btn-pill-primary">
      ...
      <div className="dash-card">
        ...
        {isLoading ? (
          ...
          <div className="divide-y divide-dash-border">
            {banks.map((bank) => (
              <BankItem key={bank.id} bank={bank} lang={lang} />
            ))}
          </div>
        ) : (
