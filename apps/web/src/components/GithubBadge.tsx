  ...
  return (
    <>
      ...
      <motion.a
        ...
        className="github-badge fixed right-4 top-20 z-40 flex items-center gap-2.5 rounded-full border border-white/10 bg-black/40 px-4 py-2 text-sm backdrop-blur-sm opacity-60 transition-opacity duration-300 hover:opacity-100 md:right-6"
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: shouldAnimate ? 0.6 : 0, x: shouldAnimate ? 0 : 20 }}
          ...
          >
            <div className="star-wrapper relative inline-block">
              <svg
                ...
                style={{ filter: "drop-shadow(0 0 0.5px rgba(251, 191, 36, 0.2))" }}
              >
                <defs>
