...
import { ChatEmpty } from "../../components/custom/ChatEmpty";

// Services
import { ChatService } from "../../services/ChatService";

// Types
import { MessageType } from "../../components/custom/ChatMessage";
...
interface ChatbotScreenProps extends AppStackScreenProps<"Chatbot"> {}
...
export const ChatbotScreen: FC<ChatbotScreenProps> = observer(
  function ChatbotScreen({ route }) {
    ...
    // Get the height of the bottom tab bar if it exists
    let tabBarHeight = 0;
    try {
      tabBarHeight = useBottomTabBarHeight();
    } catch (error) {
      // If the hook fails (possibly because we're not in a tab navigator context)
      // Use a default height for the tab bar
      tabBarHeight = 60;
    }
